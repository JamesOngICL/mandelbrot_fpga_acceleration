...
COMMON_REPO ?= $(shell bash -c 'export MK_PATH=$(MK_PATH); echo $${MK_PATH%/home/jpc369/ece6775_final/mandelbrot/all_files/*}')
...
ifeq ($(TARGET),$(filter $(TARGET),sw_emu hw_emu))
	...
	$(ECHO) '$(EXECUTABLE) mandelbrot_compute.xclbin' >> run_app.sh
