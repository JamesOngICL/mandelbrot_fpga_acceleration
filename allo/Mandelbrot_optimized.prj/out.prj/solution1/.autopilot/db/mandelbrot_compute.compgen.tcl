...
set id 10
set name mandelbrot_compute_mux_3009_8_1_1
...
set ID 12
set hasByteEnable 0
set MemName mandelbrot_compute_buf0_RAM_AUTO_1R1W
...
set name mandelbrot_compute_gmem0_m_axi
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 13 \
			corename mandelbrot_compute_control_axilite \
			name mandelbrot_compute_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler mandelbrot_compute_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
