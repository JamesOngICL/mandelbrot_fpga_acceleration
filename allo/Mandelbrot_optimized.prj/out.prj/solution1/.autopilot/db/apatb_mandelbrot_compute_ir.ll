; ModuleID = '/home/jpc369/ece6775_final/mandelbrot/all_files/test1.prj/out.prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline
define void @apatb_mandelbrot_compute_ir(i8* noalias nocapture nonnull %v107) local_unnamed_addr #0 {
entry:
  %v107_copy = alloca i8, align 512
  call fastcc void @copy_in(i8* nonnull %v107, i8* nonnull align 512 %v107_copy)
  call void @apatb_mandelbrot_compute_hw(i8* %v107_copy)
  call void @copy_back(i8* %v107, i8* %v107_copy)
  ret void
}
...
declare void @apatb_mandelbrot_compute_hw(i8*)
...
define void @mandelbrot_compute_hw_stub_wrapper(i8*) #4 {
entry:
  call void @copy_out(i8* null, i8* %0)
  call void @mandelbrot_compute_hw_stub(i8* %0)
  call void @copy_in(i8* null, i8* %0)
  ret void
}

declare void @mandelbrot_compute_hw_stub(i8*)
